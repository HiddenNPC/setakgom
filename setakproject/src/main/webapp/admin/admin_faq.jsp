...
<body>
	...
	<table id=faq-table>	
		...
		<tbody><tr>
			<td><%=i+1%></td> 
			<td><%=vo.getFaq_cate() %></td> 
			<td><%=vo.getFaq_title() %></td> 
			<td><%=vo.getFaq_content() %></td> 
			<td><%=vo.getFaq_date() %></td> 
			<td><input type="hidden" name="faq_num" value="<%=vo.getFaq_num()%>">
				<input type="button" name="setting-button" class="open" value="설정"></td></tr>			
		</tbody><%} %><%} %>
	</table>
	...
	<table id=faq-table>	
		...
		<tbody><tr>
			...
			<td><%=vo.getFaq_date() %></td> 
			<td><input type="hidden" name="faq_num" value="<%=vo.getFaq_num()%>">
				<input type="button" name="setting-button" value="설정"></td></tr>		
		</tbody><%} %><%} %>
	</table>
...
<form action="xxxx" method="post" enctype="multipart/form-data" name="reviewform" onsubmit="">
<table>
	<tr><td>
		<select>
       ...
       <td>제목 :&nbsp;<input type="text"></td></tr>
    <tr><td colspan="2"><p>내용 &nbsp;</p><textarea></textarea></td></tr>                 
	<tr><td colspan="2">
