      ...
      $(document).ready(function() {         
         //모달팝업 오픈
          $(".open").on('click', function(){
             ...
             $("#ad-faq-setting-btn1").on('click', function(){
            	 location.reload();
                $(".u-faq-form").attr('action', "admin_faqInsert.do");
                $('#ad-faq-submit').before('<tr id="u-faq-op" ><td colspan="2"><span>글 번호:<input type="hidden" id="u-faq_num" name="faq_num" value=""></span></td></tr>');
             ...
             $("#ad-faq-setting-btn2").off('click').on('click', function(){                          
            	 ...
            	 if(!$(".u-faq-form").hasClass("active")){
                	...
                	$(".u-faq-form").attr('action', "admin_faqUpdate.do");
                	$('#ad-faq-submit').before('<tr id="u-faq-op" ><td colspan="2"><span>글 번호:<input type="text" id="u-faq_num" name="faq_num" value=""></span></td></tr>');
             ...
             $("#ad-faq-setting-btn3").on('click', function(){          	
                $(".u-faq-form").attr('action', "admin_faqDelete.do");
                $(".u-faq-form").removeClass("active");
...
<body>
   ...
   <div class="content">
   <!-- 여기서부터 작업하세요. -->
   <h1><a href="./admin_faq.do">FAQ관리</a></h1>
   <!--몸통 시작-->
   ...
   <table id=faq-table>   
      <thead id=faq-thead ><tr>
         <th width="35px">번호</th><th width="70px">분류</th><th width="200px">제목</th>
         <th width="650px">내용</th><th colspan="2">작성일</th></tr>
      </thead>
...
<h2>관리자 설정 </h2>
<div>
   <button id="ad-faq-setting-btn1">추가</button>      
